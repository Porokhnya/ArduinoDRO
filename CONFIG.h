...
#define DIGIT_PLACES 4 // сколько минимум знаков использовать до запятой при отображении значения оси (т.е. всего разрядов получается DIGIT_PLACES + 1 под минус + 2 под дробные)
...
#define X_RAD_CAPTION "X RAD" // подпись на кнопке переключения "радиус" оси X (умножение на 2 - в режиме диаметра, без умножений - в режиме радиуса), можно на русском
#define X_DIA_CAPTION "X DIA" // подпись на кнопке переключения "диаметр" оси X (умножение на 2 - в режиме диаметра, без умножений - в режиме радиуса), можно на русском
...
#define Z_RAD_CAPTION "Z RAD" // подпись на кнопке переключения "радиус" оси Z (умножение на 2 - в режиме диаметра, без умножений - в режиме радиуса), можно на русском
#define Z_DIA_CAPTION "Z DIA" // подпись на кнопке переключения "диаметр" оси Z (умножение на 2 - в режиме диаметра, без умножений - в режиме радиуса), можно на русском
...
#endif
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// СЫРЫЕ НАСТРОЙКИ, НЕ РЕКОМЕНДУЮТСЯ К ИСПОЛЬЗОВАНИЮ !!!
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
