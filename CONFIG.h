...
#define SCALES_UPDATE_INTERVAL 100 // через сколько миллисекунд обновлять данные с линеек (не стоит делать это значение слишком маленьким!), актуально для линеек с протоколом 21-бит
