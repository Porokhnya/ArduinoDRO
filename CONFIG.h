...
#define MAIN_SCREEN_AXIS_V_SPACING 70 // промежуток по Y между осями
...
#define DIGIT_PLACES 4 // сколько минимум знаков использовать до запятой при отображении значения оси
...
#define HARDWARE_BUTTONS_TIMER Timer3 // какой таймер использовать для кнопок
...
//#define DEBUG_RANDOM_GENERATE_VALUES  // режим отладки, генерируются случайные значения на линейках, ЗАКОММЕНТИРОВАТЬ!


//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройки информационных диодов (НЕ ОБРАЩАЕМ ВНИМАНИЕ, ЭТО ХВОСТЫ С ПРЕДЫДУЩЕГО ПРОЕКТА)
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//#define USE_STEPPER_RUN_DIODE // закомментировать, если не надо использовать светодиод индикации
#define STEPPER_RUN_DIODE_PIN A1 // номер пина светодиода индикации
#define STEPPER_RUN_DIODE_ON HIGH // уровень включения  светодиода индикации
