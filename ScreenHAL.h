...
extern int utf8_strlen(const String& str); // возвращает кол-во символов в строке UTF-8
extern void drawScreenCaption(HalDC* hal, const char* str); // рисует заголовок экрана
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
